...
Language.create(name: 'Ruby', date_created: '1995', latest_version:'Ruby 2.4.2', creator: 'Yukihiro Matsumoto', short_description: 'Ruby is used in a wide range of fields, but is best known as a language for Web Applications, because of the Ruby on Rails framework. The general purpose nature of Ruby makes it suitable for a wide array of programming tasks, just like Perl, Python and other general purpose languages.')

Language.create(name: 'Java', date_created: '1995', latest_version:'Java 8.0', creator: 'James Gosling', short_description: 'Java is a general-purpose computer programming language that is concurrent, class-based, object-oriented, and specifically designed to have as few implementation dependencies as possible.')
