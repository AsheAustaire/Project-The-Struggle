# [language-name] is a [dynamic/static][paradigm] language which is [weak/strong].

Language.create(name: 'JavaScript', date_created: '1995', latest_version:'ECMAScript 2017', creator: 'Brendan Eich', short_description: 'JavaScript is a dynamic imperitive language, which is weakly typed.', dev_type: 'Front-End', img: 'javascript100.png')
